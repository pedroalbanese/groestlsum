...
func main() {
	...
	if len(os.Args) < 2 {
		fmt.Fprintln(os.Stderr, "GROESTLSUM Copyright (c) 2020-2021 ALBANESE Research Lab")
		fmt.Fprintln(os.Stderr, "Groestl Recursive Hasher written in Go\n")
		fmt.Fprintln(os.Stderr, "Usage of", os.Args[0]+":")
		fmt.Fprintf(os.Stderr, "%s [-v] [-c <hash.gr>] [-r] <file.ext>\n", os.Args[0])
		flag.PrintDefaults()
		os.Exit(1)
	}
